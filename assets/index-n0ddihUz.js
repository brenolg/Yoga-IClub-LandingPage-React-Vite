...
`;function qp({isMobile:e,isTablet:t,isTabletAndMobile:n}){const r=()=>e?"text-xs":t?"text-sm":"text-lg";return d.jsxs(d.Fragment,{children:[d.jsx(Mg,{id:"contact","data-aos":"fade-zoom-in","data-aos-easing":"ease-in-back","data-aos-delay":"150","data-aos-offset":"0",children:d.jsxs("div",{className:"about-section","data-aos":"fade-zoom-in","data-aos-easing":"ease-in-back",children:[n&&d.jsx("h4",{className:"about-title",children:"Olá! Eu sou Isabella Cayuela,"}),d.jsx("div",{className:"img-container",children:d.jsx("div",{className:"image",alt:"Isabella Cayuela"})}),d.jsxs("div",{className:"text-xs text-container",children:[!n&&d.jsx("h4",{className:"about-title",children:"Olá! Eu sou Isabella Cayuela,"}),d.jsx("p",{className:r(),children:"Há mais de 7 anos estudo, vivencio e ensino o Yoga para quem se propõe a embarcar na sua jornada de autoconhecimento e autocuidado."}),d.jsx("p",{className:r(),children:"Minha missão é transformar a vida das pessoas através da prática, fortalecer o corpo e a mente de quem firma o compromisso com sua melhor versão."}),d.jsx("p",{className:r(),children:"Com o objetivo de democratizar e acessibilizar o Yoga, criei o Yoga iClub, em 2021. Nossa plataforma conta com mais de 100 aulas entre elas: práticas de Yoga, respiratórios e meditações guiados. Aulas novas são adicionadas na plataforma toda semana."}),d.jsx("p",{className:r(),children:"Através da minha metodologia, tivemos mais de 500 vidas impactadas e transformadas. Vem fazer parte dessa comunidade também!"})]})]})}),d.jsxs(Dg,{children:[d.jsx("h4",{className:"doubt-about-title",children:"Ainda com dúvidas?"}),d.jsx("button",{className:"doubt-about-button",type:"button",children:d.jsx("a",{href:"https://api.whatsapp.com/send/?phone=5531996793158",target:"_blank",rel:"noopener noreferrer",children:"CONVERSE COMIGO"})})]})]})}qp.propTypes={isMobile:_.bool.isRequired,isTablet:_.bool.isRequired};const bg=ie.section`
  color: var(--C4);
  padding: var(--spacing-s7, 56px) 76px;
...
`;function y0(){return d.jsx(Jv,{children:d.jsxs("nav",{className:" headerNav",children:[d.jsx("button",{className:"header-link",type:"button",children:d.jsx(gt,{to:"start",...Lt,children:" início "})}),d.jsx("button",{className:"header-link desktop-link",type:"button",children:d.jsx(gt,{to:"students",...Lt,children:" depoimentos "})}),d.jsx(gt,{className:"logo-header",to:"prices",...Lt,children:d.jsx("img",{alt:"logo",src:h0})}),d.jsx("button",{className:"header-link desktop-link",type:"button",children:d.jsx(gt,{to:"doubts",...Lt,children:" dúvidas"})}),d.jsx("button",{className:"header-link",type:"button",children:d.jsx(gt,{to:"contact",...Lt,children:" contato "})})]})})}y0.propTypes={isTablet:_.bool.isRequired};const ey="/Yoga-IClub-LandingPage-React-Vite/assets/hero-Dk5yNB1h.jpg",ty=ie.section`
  flex-direction: row;
  display: flex;
  justify-content: center;
...
`;function Er({isMobile:e,img:t,text:n}){return d.jsxs(ky,{className:"pillar",children:[d.jsx("img",{alt:"tech-img",src:t}),d.jsx("p",{className:e?"text-sm":"text-md",children:n})]})}Er.propTypes={isMobile:_.bool.isRequired,img:_.string.isRequired,text:_.string.isRequired};function N0({isMobile:e}){return d.jsx(Cy,{children:d.jsxs("div",{className:"access_section ","data-aos":"fade-zoom-in","data-aos-easing":"ease-in-back","data-aos-delay":"150","data-aos-offset":"0",children:[d.jsx("h4",{className:" access-title",children:"O que terá acesso?"}),d.jsxs("div",{className:"main_container",children:[d.jsx(Er,{isMobile:e,img:Sy,text:"Aulas ao vivo toda semana com correção e ajustes mentoradas por mim"}),d.jsx(Er,{isMobile:e,img:wy,text:`Aulas com diferentes níveis e durações para não se sentir\r
